"""SpotAX utilities for checkpoint management and preemption handling.
...
Orbax Autocheckpoint:
    SpotAX enables GCP's autocheckpoint feature. When preemption occurs:
...
Environment variables (set by SpotAX CLI):
